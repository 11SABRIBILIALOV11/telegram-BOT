...
def welcome(message):
    ...
    if message.text == '/start':
        ...
        bot.send_message(message.chat.id,f'Привет,{message.from_user.first_name}!\nУ меня ты сможешь купить некоторые товары!\nКонтакт моего разработчика: https://t.me/SabriBilialov', reply_markup=markup)
...
def info(message):
    if message.text =='🛍 Товары':
        ...
        webbrowser.open('https://www.youtube.com/@sabribilialov')
